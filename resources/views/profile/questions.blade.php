<x-profile :user="$user">
    ...
    <div class="bg-white rounded-3 p-3 pb-2 my-3">
            ...
            <p class="text-muted">{{$question->created_at}}  @if ($question->asker_id) Asking <a href="/{{$question->asker->username}}" class="text-decoration-none text-dark">{{ucwords($question->asker->name)}}</a> @endif</p>
