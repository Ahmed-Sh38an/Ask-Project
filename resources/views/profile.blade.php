    ...
    <div class="container mt-5" style="max-width: 900px;">
        ...
        <div class="my-5 row">
            <section class="col-md-7 me-3" >
                <form action="#" method="post" class="border border-dark rounded-3 px-3 py-4 pe-0" style="background-color: #141111;">
                    @csrf 
                    <p class="text-white fw-bold">Ask {{ucwords($user->name)}}</p>
                    <textarea name="question" id="question" cols="30" rows="1" placeholder="What,when,why... ask" class="px-2 py-2 rounded-3 mb-3" style="width: 95%;" maxlength="300"></textarea>
                    <div class="row">
